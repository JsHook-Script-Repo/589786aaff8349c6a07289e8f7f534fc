...
2. 备份userkey，路径是 手机内部存储/Android/data/jp.co.lifewonders.housamo/files/datas/userkey
3. JsHook -> 应用 -> LiveAHero -> 注入Hook服务 -> 卸载再安装 -> 把 **帐号引继** 或者 **进入主界面关闭游戏，覆盖userkey** 完成后，进入主界面确认是之前的账号，再启动Hook
### 游戏更新后：
